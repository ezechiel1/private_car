...
<body>
          ...
          <div class="row">
            ...
            <!--Grid column-->
                          ...
                          <div class="col-md-2">
                           ...
                           <a type="submit" href="registration.php" style="background: #e8491d; font-weight: bold; font-size: 11px" name="delet" class="btn btn-lg fa fa-arrow-right col-md-1 ">continue</a>
                        </div>
   ...
   <footer>
     <p> Acme webdesign,copyright &copy, 2017 Powered by TeamX </p>
   </footer>

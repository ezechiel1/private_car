...
<?php if(!empty($availableCars)): foreach($availableCars as $show): ?>
   		<div class="box col-md-4"  style="border: 1px solid grey; margin-right: 3.2%;">
   			<a href="payment_report.php?request=<?php echo $show['trip_id'];?>"><img style="width: 300px; height: 170px;" src="../img/cars/<?php echo $show['car_picture']; ?>"></a>
   			...
   			<ul class="container-fluid car-list">
   				...
   				<li>Vehicle Plate : <strong class="pull-right"><?php echo $show['car_plate']; ?></strong></li>
					...
					<center><a href="payment_report.php?request=<?php echo $show['trip_id'];?>" style="background: #e8491d; color: white;margin-left: 0%;margin-bottom: 0px;font-size: 11px;" class="btn btn-xs col-md-12" >VIEW THE PAYMENT</a></center>
   			</ul>
   		</div>
